...
### main
 ...
 - [ ] Improved keyboard accessibility by adding some navigation shortcuts (this list will be moved to the about page):
   ...
   - [x] Press <kbd>ArrowDown</kbd> or <kbd>ArrowUp</kbd> to switch between desk children when focusing on the desk children.
   ...
   - [x] Press <kbd>ArrowDown</kbd> or <kbd>Home</kbd> to focus to the first desk children when focusing on the desk block.
   ...
   - [x] Press <kbd>ArrowLeft</kbd> or <kbd>End</kbd> to focus to the last desk children when focusing on the desk block and when the `flex` option is enabled.
   ...
   - [x] Press <kbd>ArrowRight</kbd> or <kbd>Home</kbd> to focus to the first desk children when focusing on the desk block and when the `flex` option is enabled.
   ...
   - [x] Press <kbd>ArrowUp</kbd> or <kbd>End</kbd> to focus to the last desk children when focusing on the desk block.
