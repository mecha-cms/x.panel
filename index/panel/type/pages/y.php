...
$_ = x\panel\type\pages\y(array_replace_recursive($_, []));
...
foreach ($pages as $k => $v) {
    ...
    $pages[$k] = [
        ...
        'tasks' => [
            ...
            'recover' => [
                'description' => ['Recover to the previous version: %s', (new Time(substr((string) strstr(basename($can_recover, '.zip'), '.'), 1)))->format('Y/m/d H:i:s')],
