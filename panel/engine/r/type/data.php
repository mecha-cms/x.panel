        ...
        'lot' => [
            ...
            0 => [
                'lot' => [
                    'folder' => ['skip' => true],
                    'link' => [
                        'url' => $url . $_['/'] . '/::g::/' . ('g' === $_['task'] ? dirname($_['path']) : $_['path']) . $x . $url->query('&', ['tab' => ['data'], 'type' => false]) . $url->hash,
                        'skip' => false
                    ],
                    's' => [
                        ...
                        'url' => str_replace('::g::', '::s::', dirname($url->clean)) . $url->query('&', ['tab' => false, 'type' => 'data']) . $url->hash,
                        'skip' => 's' === $_['task'],
                        'stack' => 10.5
                    ]
                ]
