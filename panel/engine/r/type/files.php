                            ...
                            'tasks' => [
                                ...
                                'lot' => [
                                    'blob' => [
                                        ...
                                        'description' => 'Upload',
                                        'type' => 'link',
                                        'url' => $url . $_['/'] . '/::s::/' . $_['path'] . $url->query('&', ['tab' => false, 'type' => 'blob']) . $url->hash,
                                    ...
                                    'file' => [
                                        ...
                                        'url' => $url . $_['/'] . '/::s::/' . $_['path'] . $url->query('&', ['tab' => false, 'type' => 'file']) . $url->hash,
                                    ...
                                    'folder' => [
                                        ...
                                        'url' => $url . $_['/'] . '/::s::/' . $_['path'] . $url->query('&', ['tab' => false, 'type' => 'folder']) . $url->hash,
                                        'icon' => 'M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z',
                                        'stack' => 30
                                    ]
                                ],
