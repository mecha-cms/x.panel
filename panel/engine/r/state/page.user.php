                                        ...
                                        'lot' => [
                                            'fields' => [
                                                ...
                                                'lot' => [
                                                    'title' => ['hidden' => true],
                                                    'author' => [
                                                        'description' => $_['task'] === 's' ? 'Display name.' : null,
                                                        'type' => 'Text',
                                                        'name' => 'page[author]',
                                                        'alt' => $_['task'] === 'g' ? ($page['author'] ?? To::title($page->name ?? i('John Doe'))) : To::title($page->name ?? i('John Doe')),
                                                        'value' => $page['author'],
                                                        'width' => true,
                                                        'stack' => 10
                                                    ],
                                                    'name' => [
                                                        ...
                                                        'alt' => To::kebab($_['task'] === 'g' ? ($page->name ?? 'John Doe') : 'John Doe'),
                                                        'focus' => true,
                                                        'hidden' => false,
                                                        'stack' => 11
                                                    ],
