...
$GLOBALS['page'] = $page = is_file($f = $_['f']) ? new Page($f) : new Page;
                                                                ...
                                                                'tasks' => function($in) use($_, $language, $page, $url) {
                                                                    ...
                                                                    return [
                                                                        'g' => [
                                                                            ...
                                                                            'url' => $before . 'g' . $after . $url->query('&', ['tab' => false, 'x' => $page->x]) . $url->hash,
                                                                            'stack' => 10
                                                                        ],
                                                                        'l' => [
                                                                            'title' => $language->doDelete,
                                                                            'icon' => 'M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19M8,9H16V19H8V9M15.5,4L14.5,3H9.5L8.5,4H5V6H19V4H15.5Z',
                                                                            'url' => $before . 'l' . $after . $url->query('&', ['tab' => false, 'token' => $_['token'], 'x' => $page->x]),
                                                                            'stack' => 20
                                                                        ]
                                                                    ];
                                                                },
                                                            ...
                                                            'tasks' => [
                                                                ...
                                                                'lot' => [
                                                                    's' => [
                                                                        ...
                                                                        'title' => $language->data(2),
                                                                        'url' => $url . $_['//'] . '/::s::' . Path::F($_['path']) . $url->query('&', ['content' => 'data', 'tab' => false, 'x' => $page->x]) . $url->hash,
                                                                        'stack' => 10
                                                                    ]
                                                                ],
                                                                'stack' => 20
