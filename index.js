(function () {
    ...
    function _maybeArrayLike(r, a, e) {
        if (a && !Array.isArray(a) && "number" == typeof a.length) {
            var y = a.length;
            return _arrayLikeToArray$1(a, void 0 !== e && e < y ? e : y);
        }
        return r(a, e);
    }
    ...
    var clearTimeout$1 = W.clearTimeout,
        setTimeout$1 = W.setTimeout; // For better minification
    ...
    var filter = debounce(function ($, input, _options, selectOnly) {
        ...
        if (selectOnly) {
            forEachMap(_options, function (v) {
                ...
                if ("" !== q && q === text.slice(0, toCount(q)) && !getAria(v[2], TOKEN_DISABLED$1)) {
                    selectToOption(v[2], $);
                    return 0;
                }
                --count;
    ...
    function onPasteTextInput$1(e) {
        ...
        toggleHint$1(1, picker), insertAtSelection($, e.clipboardData.getData('text/plain'));
    }
    ...
    OptionPicker._ = setObjectMethods(OptionPicker, {
        ...
        fit: function fit() {
            ...
            var borderMaskBottom = getStyle(mask, 'border-bottom-width'),
                ...
                rectMask = getRect$1(mask),
                rectWindow = getRect$1(W);
    ...
    function onCutTextInput() {
        toggleHint(1, getReference$2(this));
    }
